...
export const LinePrimaryXAxis = {
  valueType: "DateTime",
  minimum: new Date("2022, 7, 1"),
  maximum: new Date("2022, 9, 28"),
  labelFormat: "MM/dd",
  intervalType: "Days",
...
export const themeColors = [
  ...
  { name: "Iron", color: "#545454" },
  { name: "Dim", color: "#737373" },
  { name: "Gray", color: "#A6A6A6" },
  { name: "Sliver", color: "#D9D9D9" },
  { name: "Almond", color: "#D3CCBE" },

  { name: "Red", color: "#FF1517" },
  { name: "Coral", color: "#FF5758" },
  { name: "Pink", color: "#FF66C4" },
  { name: "Magenta", color: "#CC6CE5" },
  { name: "Purple", color: "#8C52FF" },
  { name: "Violet", color: "#5D17EA" },

  { name: "Turquoise", color: "#01989E" },
  { name: "Xavick", color: "#0497cc" },
  { name: "Sky", color: "#32CCFF" },
  { name: "Aqua", color: "#37B6FE" },
  { name: "Royal", color: "#5371FF" },
  { name: "Indigo", color: "#004BAD" },

  { name: "Forest", color: "#008036" },
  { name: "Grass", color: "#7ED957" },
  { name: "Kelly", color: "#CAE165" },
  { name: "Yellow", color: "#FEDE58" },
  { name: "Bisque", color: "#FFBE5A" },
  { name: "Orange", color: "#FF924D" },
];
...
export const lineChartData = [
  [
    { x: new Date(2022, 6, 3), y: -8.23 },
    { x: new Date(2022, 6, 10), y: 8.1 },
    { x: new Date(2022, 6, 17), y: -0.39 },
    { x: new Date(2022, 6, 24), y: 8.81 },
    { x: new Date(2022, 6, 31), y: 3.22 },
    { x: new Date(2022, 7, 7), y: -0.69 },
    { x: new Date(2022, 7, 14), y: 4.93 },
    { x: new Date(2022, 7, 21), y: -11.45 },
    { x: new Date(2022, 7, 28), y: -8.9 },
    { x: new Date(2022, 8, 4), y: 1.89 },
    { x: new Date(2022, 8, 11), y: 8.92 },
    { x: new Date(2022, 8, 18), y: -10.79 },
    { x: new Date(2022, 8, 25), y: -3.18 },
  ],
  [
    { x: new Date(2022, 6, 3), y: -10.51 },
    { x: new Date(2022, 6, 10), y: 8.81 },
    { x: new Date(2022, 6, 17), y: 14.53 },
    { x: new Date(2022, 6, 24), y: 19.49 },
    { x: new Date(2022, 6, 31), y: 5.13 },
    { x: new Date(2022, 7, 7), y: 1.06 },
    { x: new Date(2022, 7, 14), y: 13.97 },
    { x: new Date(2022, 7, 21), y: -16.39 },
    { x: new Date(2022, 7, 28), y: -11.66 },
    { x: new Date(2022, 8, 4), y: 10.28 },
    { x: new Date(2022, 8, 11), y: 11.67 },
    { x: new Date(2022, 8, 18), y: -24.21 },
    { x: new Date(2022, 8, 25), y: -3.08 },
  ],
  [
    { x: new Date(2022, 6, 3), y: -0.03 },
    { x: new Date(2022, 6, 10), y: 0.04 },
    { x: new Date(2022, 6, 17), y: 0.03 },
    { x: new Date(2022, 6, 24), y: 0.03 },
    { x: new Date(2022, 6, 31), y: 0.03 },
    { x: new Date(2022, 7, 7), y: -0.02 },
    { x: new Date(2022, 7, 14), y: 0.01 },
    { x: new Date(2022, 7, 21), y: -0.03 },
    { x: new Date(2022, 7, 28), y: 0 },
    { x: new Date(2022, 8, 4), y: 0 },
    { x: new Date(2022, 8, 11), y: 0.02 },
    { x: new Date(2022, 8, 18), y: -0.03 },
    { x: new Date(2022, 8, 25), y: 0 },
  ],
  [
    { x: new Date(2022, 6, 3), y: -6.36 },
    { x: new Date(2022, 6, 10), y: 7.16 },
    { x: new Date(2022, 6, 17), y: 5.62 },
    { x: new Date(2022, 6, 24), y: 5.66 },
    { x: new Date(2022, 6, 31), y: 8.29 },
    { x: new Date(2022, 7, 7), y: 13.87 },
    { x: new Date(2022, 7, 14), y: -1.53 },
    { x: new Date(2022, 7, 21), y: -8.01 },
    { x: new Date(2022, 7, 28), y: -1.54 },
    { x: new Date(2022, 8, 4), y: 0.94 },
    { x: new Date(2022, 8, 11), y: 5.85 },
    { x: new Date(2022, 8, 18), y: -9.77 },
    { x: new Date(2022, 8, 25), y: 2.91 },
  ],
  [
    { x: new Date(2022, 6, 3), y: -10.36 },
    { x: new Date(2022, 6, 10), y: 1.23 },
    { x: new Date(2022, 6, 17), y: 5.45 },
    { x: new Date(2022, 6, 24), y: 4.61 },
    { x: new Date(2022, 6, 31), y: 5.9 },
    { x: new Date(2022, 7, 7), y: -2.09 },
    { x: new Date(2022, 7, 14), y: 1.06 },
    { x: new Date(2022, 7, 21), y: -8.27 },
    { x: new Date(2022, 7, 28), y: -6.43 },
    { x: new Date(2022, 8, 4), y: 2.69 },
    { x: new Date(2022, 8, 11), y: 7.03 },
    { x: new Date(2022, 8, 18), y: 0.9 },
    { x: new Date(2022, 8, 25), y: 37.48 },
  ],
  [
    { x: new Date(2022, 6, 3), y: -8.2 },
    { x: new Date(2022, 6, 10), y: 0.12 },
    { x: new Date(2022, 6, 17), y: -6.18 },
    { x: new Date(2022, 6, 24), y: 7.32 },
    { x: new Date(2022, 6, 31), y: 0.81 },
    { x: new Date(2022, 7, 7), y: 0.98 },
    { x: new Date(2022, 7, 14), y: 18.49 },
    { x: new Date(2022, 7, 21), y: -14.98 },
    { x: new Date(2022, 7, 28), y: -11.03 },
    { x: new Date(2022, 8, 4), y: 2.33 },
    { x: new Date(2022, 8, 11), y: 0.77 },
    { x: new Date(2022, 8, 18), y: -9.72 },
    { x: new Date(2022, 8, 25), y: 6.32 },
  ],
];
